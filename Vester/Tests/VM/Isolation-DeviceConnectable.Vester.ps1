...
# vSphere 6.0 Hardening Guide Guideline ID - VM.prevent-device-interaction-connect

# Test title, e.g. 'DNS Servers'
$Title = 'Isolation - Device Interaction Connect'

# Test description: How New-VesterConfig explains this value to the user
$Description = 'Prevent unauthorized users from connecting or disconnecting devices or network adapters'

# The config entry stating the desired values
$Desired = $cfg.vm.isolationdeviceconnectable
