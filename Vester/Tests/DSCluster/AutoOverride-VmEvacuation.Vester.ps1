...
$Title = 'SDRS Automation Override: VM Evacuation'

# Test description: How New-VesterConfig explains this value to the user
$Description = 'Specifies the behavior of SDRS when it generates recommendations for datastore evacuations in a datastore cluster'

# The config entry stating the desired values
$Desired = $cfg.dscluster.autooverridevmevac
