...
$Title = 'SDRS Automation Override: Space Load Balance'

# Test description: How New-VesterConfig explains this value to the user
$Description = 'Specifies the behavior of SDRS when it generates recommendations for correcting storage and VM policy violations in a datastore cluster'

# The config entry stating the desired values
$Desired = $cfg.dscluster.autooverridespaceloadbalance
