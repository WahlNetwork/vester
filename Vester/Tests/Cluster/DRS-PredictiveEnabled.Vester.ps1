...
$Title = 'Predictive DRS State'

# Test description: How New-VesterConfig explains this value to the user
$Description = 'On/off switch for Predictive Distributed Resource Scheduler (DRS) on the cluster'

# The config entry stating the desired values
$Desired = $cfg.cluster.predictivedrsenable
...
[ScriptBlock]$Actual = {
    ($Object | Get-View).ConfigurationEx.ProactiveDrsConfig.Enabled
}
