...
$Title = 'lwsmd (Active Directory) Service State'

# Test description: How New-VesterConfig explains this value to the user
$Description = 'Checks state of lwsmd (Active Directory) service (running or stopped)'

# The config entry stating the desired values
$Desired = $cfg.host.lwsmdservicerunning
